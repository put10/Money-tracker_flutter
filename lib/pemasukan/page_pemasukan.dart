...
import 'package:moneytracker/database/DatabaseHelper.dart';
import 'package:moneytracker/decoration/format_rupiah.dart';
import 'package:moneytracker/model/model_database.dart';
import 'package:moneytracker/pemasukan/page_input_pemasukan.dart';
...
class _PagePemasukanState extends State<PagePemasukan> {
  ...
  Future<void> openFormCreate() async {
    var result = await Navigator.push(context,
        MaterialPageRoute(builder: (context) => const PageInputPemasukan()));
    if (result == 'save') {
      await getAllData();
      await getJmlUang();
      await getDatabase();
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text('Jumlah Uang: ${CurrencyFormat.convertToIdr(
