...
import 'package:moneytracker/pengeluaran/page_input_pengeluaran.dart';
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('Jumlah Uang: ${CurrencyFormat.convertToIdr(int.parse(modeldatabase.jml_uang.toString()))}',
                                style: const TextStyle(
                                    fontSize: 12,
                                    color: Colors.black)),
                          ),
